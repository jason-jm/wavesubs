...
T['ja'] = dict(
  ...
  cta_mac='macOS 版を無料ダウンロード', cta_win='Windows 版を無料ダウンロード',
  pills=['SRT / ASS 字幕を生成', 'あなたの言語に自動翻訳（29 言語）', 'ローカル AI · ネット不要 · ずっと無料'],
  ...
  dl_h2='無料ダウンロード', dl_sub=f'バージョン {VERSION}。ffmpeg と whisper.cpp は同梱済み。インストールしてすぐ使えます。',
...
T['ko'] = dict(
  ...
  cta_mac='macOS용 무료 다운로드', cta_win='Windows용 무료 다운로드',
  pills=['SRT / ASS 자막 생성', '내 언어로 자동 번역 (29개)', '로컬 AI · 인터넷 불필요 · 영원히 무료'],
  ...
  dl_h2='무료 다운로드', dl_sub=f'버전 {VERSION}. ffmpeg와 whisper.cpp가 내장되어 설치 후 바로 사용.',
...
T['fr'] = dict(
  ...
  cta_mac='Télécharger pour macOS', cta_win='Télécharger pour Windows',
  pills=['Sous-titres SRT / ASS', 'Traduction automatique dans votre langue (29)', 'IA locale · sans internet · gratuit pour toujours'],
  ...
  dl_h2='Téléchargement gratuit', dl_sub=f'Version {VERSION}. ffmpeg et whisper.cpp sont inclus — rien d\'autre à installer.',
...
T['de'] = dict(
  ...
  cta_mac='Kostenlos für macOS laden', cta_win='Kostenlos für Windows laden',
  pills=['SRT / ASS-Untertitel erstellen', 'Automatisch in deine Sprache (29)', 'Lokale KI · kein Internet · für immer kostenlos'],
  ...
  dl_h2='Kostenloser Download', dl_sub=f'Version {VERSION}. ffmpeg und whisper.cpp sind enthalten — installieren und loslegen.',
...
T['ru'] = dict(
  ...
  cta_mac='Скачать для macOS бесплатно', cta_win='Скачать для Windows бесплатно',
  pills=['Субтитры SRT / ASS', 'Автоперевод на ваш язык (29 языков)', 'Локальный ИИ · без интернета · бесплатно навсегда'],
  ...
  dl_h2='Скачать бесплатно', dl_sub=f'Версия {VERSION}. ffmpeg и whisper.cpp уже внутри — установите и работайте.',
...
T['id'] = dict(
  ...
  cta_mac='Unduh gratis untuk macOS', cta_win='Unduh gratis untuk Windows',
  pills=['Subtitle SRT / ASS', 'Terjemahan otomatis ke bahasa Anda (29)', 'AI lokal · tanpa internet · gratis selamanya'],
  ...
  dl_h2='Unduh gratis', dl_sub=f'Versi {VERSION}. ffmpeg dan whisper.cpp sudah disertakan — pasang dan langsung pakai.',
...
T['ms'] = dict(
  ...
  cta_mac='Muat turun percuma untuk macOS', cta_win='Muat turun percuma untuk Windows',
  pills=['Sari kata SRT / ASS', 'Terjemahan automatik ke bahasa anda (29)', 'AI tempatan · tanpa internet · percuma selamanya'],
  ...
  dl_h2='Muat turun percuma', dl_sub=f'Versi {VERSION}. ffmpeg dan whisper.cpp disertakan — pasang dan terus guna.',
...
T['vi'] = dict(
  ...
  cta_mac='Tải miễn phí cho macOS', cta_win='Tải miễn phí cho Windows',
  pills=['Phụ đề SRT / ASS', 'Tự động dịch sang ngôn ngữ của bạn (29)', 'AI cục bộ · không cần mạng · miễn phí mãi mãi'],
  ...
  dl_h2='Tải miễn phí', dl_sub=f'Phiên bản {VERSION}. ffmpeg và whisper.cpp đã đi kèm — cài là dùng.',
...
T['th'] = dict(
  ...
  cta_mac='ดาวน์โหลดฟรีสำหรับ macOS', cta_win='ดาวน์โหลดฟรีสำหรับ Windows',
  pills=['สร้างซับ SRT / ASS', 'แปลเป็นภาษาของคุณอัตโนมัติ (29 ภาษา)', 'AI ในเครื่อง · ไม่ต้องต่อเน็ต · ฟรีตลอดไป'],
  ...
  dl_h2='ดาวน์โหลดฟรี', dl_sub=f'เวอร์ชัน {VERSION} มี ffmpeg และ whisper.cpp มาพร้อมแล้ว ติดตั้งแล้วใช้ได้เลย',
